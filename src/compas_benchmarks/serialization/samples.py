...
can see the *shape* of each encoding. Regenerate with:
    ...
    python -m compas_benchmarks.serialization.samples
...
def dump_samples(out_dir, seed=fixtures.DEFAULT_SEED):
    ...
    try:
        ...
        from compas_benchmarks.serialization.formats import _msgpack_enc_hook
    except ImportError:
        msgspec = None
...
def main():
    out_dir = os.path.join(os.getcwd(), "results", "samples")
